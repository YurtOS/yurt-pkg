...
#[test]
fn lint_continuity_uses_last_published_version_not_max_semver() {
    let dir = tempfile::tempdir().unwrap();
    let package = dir.path().join("foo.json");
    fs::write(
        &package,
        r#"{
          ...
          "versions": [{
            "version": "2.0.0",
            "build": "yurt_0",
            "url": "https://github.com/YurtOS/yurt-packages/releases/download/foo-2.0.0/foo-2.0.0.yurtpkg",
            "sha256": "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
            "size": 1,
            "signing": {"subject": "old-subject", "issuer": "https://token.actions.githubusercontent.com"},
            "yanked": false
            ...
            "version": "1.1.0",
            "build": "yurt_0",
            "url": "https://github.com/YurtOS/yurt-packages/releases/download/foo-1.1.0/foo-1.1.0.yurtpkg",
